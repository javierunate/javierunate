...
![Java](https://img.shields.io/badge/Java-Primary%20Language-ED8B00?style=flat-square&logo=openjdk&logoColor=white)
![Firebase](https://img.shields.io/badge/Firebase-Cloud-FFCA28?style=flat-square&logo=firebase&logoColor=black)
![AI](https://img.shields.io/badge/AI-Product%20Development-5B5FC7?style=flat-square)
...
I'm an Android developer and product builder focused on **fitness technology, artificial intelligence and mobile software**.
...
- Native Android applications and scalable product architecture
...
### Mobile
`Java` · `Android SDK` · `Android Studio` · `Room` · `SQLite` · `Material Design`
...
`Android Architecture` · `Artificial Intelligence` · `Fitness Technology` · `Product Engineering` · `Developer Automation` · `Local LLMs` · `AI Agents`
